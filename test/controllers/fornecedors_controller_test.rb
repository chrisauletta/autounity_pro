...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { nome_fornecedor: @fornecedor.nome_fornecedor, ramo: @fornecedor.ramo, telefone: @fornecedor.telefone, vendedor: @fornecedor.vendedor } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { nome_fornecedor: @fornecedor.nome_fornecedor, ramo: @fornecedor.ramo, telefone: @fornecedor.telefone, vendedor: @fornecedor.vendedor } }
