...
class OrcamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento" do
    assert_difference('Orcamento.count') do
      post orcamentos_url, params: { orcamento: { cliente_id: @orcamento.cliente_id, descricao: @orcamento.descricao, quilometragem: @orcamento.quilometragem, status: @orcamento.status, valor_total: @orcamento.valor_total, veiculo_id: @orcamento.veiculo_id } }
    end
  ...
  test "should update orcamento" do
    patch orcamento_url(@orcamento), params: { orcamento: { cliente_id: @orcamento.cliente_id, descricao: @orcamento.descricao, quilometragem: @orcamento.quilometragem, status: @orcamento.status, valor_total: @orcamento.valor_total, veiculo_id: @orcamento.veiculo_id } }
